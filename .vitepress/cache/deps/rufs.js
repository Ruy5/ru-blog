// node_modules/rufs/dist/rufs.esm.js
var downloadM3U8 = () => {
};
...
var sliceUpload = (url, project, chunkSize) => {
  return new Promise(function(resolve, reject) {
    const upload = (file) => {
      var filePartList = [];
      ...
      function loadNext() {
        ...
        var filePart = blobSlice.call(file, start, end);
